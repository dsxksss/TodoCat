...
class DragAndDropItemTarget extends StatefulWidget implements DragAndDropItemTargetBase {
  final Widget child;
          ...
          child: DragTarget<DragAndDropItem>(
            ...
            onWillAcceptWithDetails: (details) {
              ...
              if (widget.parameters.itemTargetOnWillAccept != null) {
                accept =
                    widget.parameters.itemTargetOnWillAccept!(details.data, widget as DragAndDropItemTargetBase);
              }
              if (accept && mounted) {
                setState(() {
            ...
            onAcceptWithDetails: (details) {
              if (mounted) {
                setState(() {
                  widget.onReorderOrAdd(details.data, widget.parent!, widget as DragAndDropItemTargetBase);
                  _hoveredDraggable = null;
                });
              }
            },
