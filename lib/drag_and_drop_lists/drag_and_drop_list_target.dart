...
typedef OnDropOnLastTarget = void Function(
  ...
  DragAndDropListTargetBase receiver,
);

class DragAndDropListTarget extends StatefulWidget implements DragAndDropListTargetBase {
  final Widget? child;
          ...
          child: DragTarget<DragAndDropListInterface>(
            ...
            onWillAcceptWithDetails: (details) {
              ...
              if (widget.parameters.listTargetOnWillAccept != null) {
                accept =
                    widget.parameters.listTargetOnWillAccept!(details.data, widget as DragAndDropListTargetBase);
              }
              if (accept && mounted) {
                setState(() {
            ...
            onAcceptWithDetails: (details) {
              if (mounted) {
                setState(() {
                  widget.onDropOnLastTarget(details.data, widget as DragAndDropListTargetBase);
                  _hoveredDraggable = null;
                });
              }
            },
