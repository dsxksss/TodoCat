  ...
  static List<Task> getStudentTemplate() {
    ...
    return [
      ...
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch
        ..tagsWithColor = _createTagsWithColors(isZh ? ['学习', '语言', '日常'] : ['Learning', 'Language', 'Daily'])
        ..status = TaskStatus.todo
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch
            ..tagsWithColor = _createTagsWithColors(isZh ? ['词汇', '背诵'] : ['Vocabulary', 'Memorize'])
          ...
          Todo()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 1
            ..tagsWithColor = _createTagsWithColors(isZh ? ['听力', '播客'] : ['Listening', 'Podcast'])
      ...
      Task()
        ...
        ..tagsWithColor = _createTagsWithColors(isZh ? ['项目', '技术'] : ['Project', 'Tech'])
        ..status = TaskStatus.inProgress
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
            ..tagsWithColor = _createTagsWithColors(isZh ? ['设计', '架构'] : ['Design', 'Architecture'])
            ..priority = TodoPriority.highLevel
          ...
          Todo()
            ...
            ..description = isZh ? '为核心功能编写测试用例' : 'Write tests for core features'
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 11
            ..tagsWithColor = _createTagsWithColors(isZh ? ['测试', '质量'] : ['Testing', 'Quality'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.todo
      ...
      Task()
        ...
        ..tagsWithColor = _createTagsWithColors(isZh ? ['爱好', '艺术'] : ['Hobby', 'Art'])
        ..status = TaskStatus.done
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 20
            ..tagsWithColor = _createTagsWithColors(isZh ? ['练习'] : ['Practice'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.todo
      ...
      Task()
        ...
        ..tagsWithColor = _createTagsWithColors(isZh ? ['生活', '管理'] : ['Life', 'Management'])
        ..status = TaskStatus.todo
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 30
            ..tagsWithColor = _createTagsWithColors(isZh ? ['整理', '笔记'] : ['Organize', 'Notes'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.todo
          ...
          Todo()
            ...
            ..tagsWithColor = _createTagsWithColors(isZh ? ['运动', '健康'] : ['Exercise', 'Health'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.todo
            ..dueDate = DateTime.now().add(const Duration(days: 1)).millisecondsSinceEpoch,
        ],
  ...
  static List<Task> getWorkTemplate() {
    ...
    return [
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch
        ..tagsWithColor = _createTagsWithColors(isZh ? ['工作', '项目管理'] : ['Work', 'Project Management'])
        ..status = TaskStatus.todo
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ..title = isZh ? '准备项目提案' : 'Prepare project proposal'
            ..description = isZh ? '收集需求并撰写项目建议书' : 'Collect requirements and write proposal'
            ..createdAt = DateTime.now().millisecondsSinceEpoch
            ..tagsWithColor = _createTagsWithColors(isZh ? ['提案', '文档'] : ['Proposal', 'Document'])
            ..priority = TodoPriority.highLevel
            ..status = TodoStatus.todo
            ..dueDate = DateTime.now().add(const Duration(days: 3)).millisecondsSinceEpoch,
          Todo()
            ...
            ..description = isZh ? '讨论项目进度和下周计划' : 'Discuss progress and next week\'s plan'
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 1
            ..tagsWithColor = _createTagsWithColors(isZh ? ['会议', '协作'] : ['Meeting', 'Collaboration'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.todo
      ...
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
        ..tagsWithColor = _createTagsWithColors(isZh ? ['开发', '进行中'] : ['Development', 'In Progress'])
        ..status = TaskStatus.inProgress
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
            ..tagsWithColor = _createTagsWithColors(isZh ? ['开发', '功能'] : ['Development', 'Feature'])
            ..priority = TodoPriority.highLevel
      ...
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 20
        ..tagsWithColor = _createTagsWithColors(isZh ? ['完成', '归档'] : ['Done', 'Archived'])
        ..status = TaskStatus.done
        ..todos = [],
      Task()
        ..uuid = const Uuid().v4()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 30
        ..tagsWithColor = _createTagsWithColors(isZh ? ['工作', '待办'] : ['Work', 'Todo'])
        ..status = TaskStatus.todo
        ..todos = [],
    ];
  }
  ...
  static List<Task> getFitnessTemplate() {
    ...
    return [
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch
        ..tagsWithColor = _createTagsWithColors(isZh ? ['健身', '计划'] : ['Fitness', 'Plan'])
        ..status = TaskStatus.todo
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ..title = isZh ? '制定本周训练计划' : 'Weekly training plan'
            ..description = isZh ? '安排有氧和力量训练' : 'Schedule cardio and strength training'
            ..createdAt = DateTime.now().millisecondsSinceEpoch
            ..tagsWithColor = _createTagsWithColors(isZh ? ['计划', '训练'] : ['Plan', 'Training'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.todo
            ..dueDate = DateTime.now().add(const Duration(days: 1)).millisecondsSinceEpoch,
        ],
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
        ..tagsWithColor = _createTagsWithColors(isZh ? ['训练', '进行中'] : ['Training', 'In Progress'])
        ..status = TaskStatus.inProgress
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
            ..tagsWithColor = _createTagsWithColors(isZh ? ['力量', '训练'] : ['Strength', 'Training'])
            ..priority = TodoPriority.highLevel
            ..status = TodoStatus.inProgress
            ..progress = 80
      ...
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 20
        ..tagsWithColor = _createTagsWithColors(isZh ? ['完成', '记录'] : ['Done', 'Record'])
        ..status = TaskStatus.done
        ..todos = [],
      Task()
        ..uuid = const Uuid().v4()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 30
        ..tagsWithColor = _createTagsWithColors(isZh ? ['健身', '其他'] : ['Fitness', 'Other'])
        ..status = TaskStatus.todo
        ..todos = [],
    ];
  }
  ...
  static List<Task> getTravelTemplate() {
    ...
    return [
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch
        ..tagsWithColor = _createTagsWithColors(isZh ? ['旅行', '计划'] : ['Travel', 'Plan'])
        ..status = TaskStatus.todo
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ..title = isZh ? '预订酒店' : 'Book hotel'
            ..description = isZh ? '选择合适位置和价格的酒店' : 'Choose suitable location and price'
            ..createdAt = DateTime.now().millisecondsSinceEpoch
            ..tagsWithColor = _createTagsWithColors(isZh ? ['酒店', '预订'] : ['Hotel', 'Booking'])
            ..priority = TodoPriority.highLevel
            ..status = TodoStatus.todo
          ...
          Todo()
            ...
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 1
            ..tagsWithColor = _createTagsWithColors(isZh ? ['机票', '交通'] : ['Flight', 'Transport'])
            ..priority = TodoPriority.highLevel
            ..status = TodoStatus.todo
      ...
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
        ..tagsWithColor = _createTagsWithColors(isZh ? ['准备', '进行中'] : ['Preparation', 'In Progress'])
        ..status = TaskStatus.inProgress
        ..todos = [
          Todo()
            ..uuid = const Uuid().v4()
            ..title = isZh ? '准备行李' : 'Pack luggage'
            ..description = isZh ? '整理衣物和必需品' : 'Organize clothes and essentials'
            ..createdAt = DateTime.now().millisecondsSinceEpoch + 10
            ..tagsWithColor = _createTagsWithColors(isZh ? ['行李', '准备'] : ['Luggage', 'Preparation'])
            ..priority = TodoPriority.mediumLevel
            ..status = TodoStatus.inProgress
            ..progress = 50
            ..dueDate = DateTime.now().add(const Duration(days: 3)).millisecondsSinceEpoch,
      ...
      Task()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 20
        ..tagsWithColor = _createTagsWithColors(isZh ? ['完成', '旅行'] : ['Done', 'Travel'])
        ..status = TaskStatus.done
        ..todos = [],
      Task()
        ..uuid = const Uuid().v4()
        ...
        ..createdAt = DateTime.now().millisecondsSinceEpoch + 30
        ..tagsWithColor = _createTagsWithColors(isZh ? ['旅行', '其他'] : ['Travel', 'Other'])
        ..status = TaskStatus.todo
        ..todos = [],
    ];
  }
