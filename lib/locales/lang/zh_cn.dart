const Map<String, String> zhCN = {
  ...
  'sureDeleteWorkspace': '确定要删除工作空间吗？',
  'settings': '设置',
  'enable': '启用',
  'disable': '禁用',
  ...
  'defaultBackgroundImages': '默认背景图片',
  'defaultBackgroundVideos': '默认背景视频',
  'defaultTemplateApplied': '已应用默认模板',
  'desktopOnlyFeature': '此功能仅在桌面端可用',
  'backgroundImageSetSuccess': '背景图片已设置',
  'backgroundVideoSetSuccess': '背景视频已设置',
  ...
  'confirmApplyTemplate': '确定要应用模板吗？这将清除所有现有任务。',
  ...
  'selectUpdateMethod': '选择更新方式',
  'selectUpdateMethodDesc': '请选择您希望的更新方式：',
  'updateViaDownload': '直接下载更新',
  'updateViaDownloadDesc': '下载安装包并在本地安装',
  'updateViaStore': '通过微软商店更新',
  'updateViaStoreDesc': '跳转到微软商店进行更新',
  'openMicrosoftStore': '打开微软商店',
  'failedToOpenStore': '无法打开微软商店',
  // 回收站
  'trash': '回收站',
  'emptyTrash': '清空回收站',
  'trashEmpty': '回收站为空',
  ...
  'sureRestoreTask': '确定要恢复任务吗？',
  'sureRestoreTodo': '确定要恢复待办事项吗？',
  'surePermanentDeleteTask': '确定要永久删除任务吗？此操作不可撤销！',
  'surePermanentDeleteTodo': '确定要永久删除待办事项吗？此操作不可撤销！',
  ...
  'workspaceRenamed': '工作空间重命名成功',
  'workspaceRenameFailed': '重命名工作空间失败',
  'rename': '重命名',
  'renaming': '重命名中...',
  'deleteWorkspace': '删除工作空间',
  'workspaceDeleted': '工作空间已删除',
  'workspaceRestored': '工作空间已恢复',
  'workspaceRestoreFailed': '恢复工作空间失败',
  'deletedWorkspaces': '已删除的工作空间',
  'deletedTasks': '已删除的任务',
  'sureRestoreWorkspace': '确定要恢复工作空间吗？',
  'surePermanentDeleteWorkspace': '确定要永久删除工作空间吗？此操作不可撤销！',
  'workspacePermanentlyDeleted': '工作空间已永久删除',
  'moveToWorkspace': '移动到工作空间',
  'selectTargetWorkspace': '选择目标工作空间',
  'taskMovedToWorkspace': '任务已移动到工作空间',
  'taskMoveFailed': '移动任务失败',
  'noWorkspaces': '没有可用的工作空间',
  'currentWorkspace': '当前工作空间',
  'moveTodoToWorkspace': '移动到工作空间',
  'selectTargetTask': '选择目标任务',
  'todoMovedToWorkspace': '待办事项已移动到工作空间',
  'todoMoveFailed': '移动待办事项失败',
  'noTasksInWorkspace': '该工作空间中没有任务',
  'currentTask': '当前任务',
  // 同名项处理
  ...
  'syncCompleted': '同步完成',
  'statusLocalChanges': '本地有更改',
  'statusRemoteUpdate': '云端有更新',
  'statusConflict': '云端更新 & 本地更改',
  'historyVersions': '历史版本',
  'confirmRestoreHistory': '确定要恢复到此版本吗？\n这将覆盖当前的本地数据。',
  'noHistoryVersions': '暂无历史版本',
  'aiGenerate': 'AI 智能生成',
  'aiGenerateDesc': '输入描述，AI 帮你生成专属任务模板',
  'aiPlanning': 'AI 正在为你规划...',
  'aiGeneratingTasks': '正在生成任务清单与详细步骤',
  'aiGenerateFailed': '生成失败，请重试',
  'aiGenerateFailedRetry': '生成失败: @error\n是否重试？',
  'aiGenerateTemplate': 'AI 智能生成模板',
  'aiGenerateHint':
      '描述你想要的任务列表，例如：\n- "为期7天的云南旅游计划"\n- "准备一场马拉松的训练计划"\n- "新房装修全流程"',
  'aiGenerateButton': '立即生成',
  'aiPreview': 'AI 生成结果预览',
};
