...
import 'package:todo_cat/widgets/markdown_toolbar.dart';
...
class _TodoDialogState extends State<TodoDialog> with TickerProviderStateMixin {
  ...
  Widget _buildDialog(BuildContext context) {
                              ...
                              child: Shortcuts(
                                shortcuts: const {
                                  SingleActivator(LogicalKeyboardKey.keyV,
                                      control: true): _PasteImageIntent(),
                                },
                                child: Actions(
                ...
                Expanded(
                  child: Stack(
                    ...
                    children: [
                      ...
                      if (_showArrowHint) _buildArrowHint(context),
                    ],
                  ),
                ),
              ],
    ...
    final maxPreviewWidth =
        (screenWidth - dialogWidth - spacing - 20).clamp(0.0, double.infinity);
                                  ...
                                  child: Shortcuts(
                                    ...
                                    child: Actions(
                                      ...
                                      child: TextFormFieldItem(
                                        ...
                                        maxLength: 400,
                                        minLines:
                                            calculatedMaxLines, // 使用计算出的行数确保填充高度
                                        maxLines:
                ...
                child: IgnorePointer(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: context.theme.dialogTheme.backgroundColor,
                      border: Border.all(
                          width: 0.3, color: context.theme.dividerColor),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: Column(
                      children: [
...
class _PreviewBottomSheetState extends State<_PreviewBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      height: _isMaximized ? 1.0.sh : 0.75.sh,
      decoration: BoxDecoration(
        color: context.theme.dialogTheme.backgroundColor,
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(_isMaximized ? 0 : 20),
        ),
      ),
      child: Column(
        children: [
              ...
              child: Align(
                ...
                child: ValueListenableBuilder<TextEditingValue>(
                  ...
                  builder: (context, value, child) {
                    ...
                    return MarkdownBody(
                      data: processedText.isEmpty ? '*暂无内容*' : processedText,
                      sizedImageBuilder: (config) {
                        final uriString = config.uri.toString();
                        final isNetworkImage =
                            uriString.startsWith('http://') ||
