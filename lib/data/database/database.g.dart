  ...
  $$TasksTableTableManager(_$AppDatabase db, $TasksTable table)
      : super(TableManagerState(
          ...
          getUpdateCompanionBuilder: ({
            ...
            Value<int> reminders = const Value.absent(),
            Value<String> tags = const Value.absent(),
            Value<String> tagsWithColorJsonString = const Value.absent(),
            Value<int> deletedAt = const Value.absent(),
          }) =>
              TasksCompanion(
            id: id,
            ...
            reminders: reminders,
            tags: tags,
            tagsWithColorJsonString: tagsWithColorJsonString,
            deletedAt: deletedAt,
          ),
          getInsertCompanionBuilder: ({
            Value<int> id = const Value.absent(),
...
class $$TasksTableFilterComposer
  ...
  ColumnFilters<int> get finishedAt => $state.composableBuilder(
  ...
  ColumnFilters<int> get reminders => $state.composableBuilder(
  ...
  ColumnFilters<String> get tagsWithColorJsonString => $state.composableBuilder(
      column: $state.table.tagsWithColorJsonString,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$TasksTableOrderingComposer
  ...
  ColumnOrderings<int> get finishedAt => $state.composableBuilder(
      column: $state.table.finishedAt,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<int> get reminders => $state.composableBuilder(
      column: $state.table.reminders,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<String> get tagsWithColorJsonString =>
...
class $$TodosTableTableManager extends RootTableManager<
  ...
  $$TodosTableTableManager(_$AppDatabase db, $TodosTable table)
      : super(TableManagerState(
          ...
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
            Value<String> taskUuid = const Value.absent(),
            Value<String> uuid = const Value.absent(),
            Value<String> title = const Value.absent(),
            Value<int> createdAt = const Value.absent(),
            Value<String> description = const Value.absent(),
...
class $$TodosTableFilterComposer
  ...
  ColumnFilters<String> get taskUuid => $state.composableBuilder(
      column: $state.table.taskUuid,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$TodosTableOrderingComposer
  ...
  ColumnOrderings<String> get taskUuid => $state.composableBuilder(
      column: $state.table.taskUuid,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
typedef $$AppConfigsTableInsertCompanionBuilder = AppConfigsCompanion Function({
  Value<int> id,
  required String configName,
  Value<bool> isDarkMode,
  required String languageCode,
...
class $$AppConfigsTableTableManager extends RootTableManager<
    ...
    $$AppConfigsTableProcessedTableManager,
    $$AppConfigsTableInsertCompanionBuilder,
  ...
  $$AppConfigsTableTableManager(_$AppDatabase db, $AppConfigsTable table)
      : super(TableManagerState(
          ...
          getChildManagerBuilder: (p) =>
              $$AppConfigsTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
            ...
            Value<bool> emailReminderEnabled = const Value.absent(),
            Value<bool> isDebugMode = const Value.absent(),
            Value<String?> backgroundImagePath = const Value.absent(),
            Value<int?> primaryColorValue = const Value.absent(),
            Value<double> backgroundImageOpacity = const Value.absent(),
            Value<double> backgroundImageBlur = const Value.absent(),
            Value<bool> backgroundAffectsNavBar = const Value.absent(),
          }) =>
              AppConfigsCompanion(
            id: id,
...
class $$AppConfigsTableProcessedTableManager extends ProcessedTableManager<
    _$AppDatabase,
    $AppConfigsTable,
    AppConfig,
    $$AppConfigsTableFilterComposer,
    ...
    $$AppConfigsTableInsertCompanionBuilder,
    $$AppConfigsTableUpdateCompanionBuilder> {
  $$AppConfigsTableProcessedTableManager(super.$state);
}
...
class $$AppConfigsTableFilterComposer
  ...
  ColumnFilters<String> get configName => $state.composableBuilder(
      column: $state.table.configName,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ColumnFilters<bool> get emailReminderEnabled => $state.composableBuilder(
      column: $state.table.emailReminderEnabled,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<bool> get isDebugMode => $state.composableBuilder(
      column: $state.table.isDebugMode,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<String> get backgroundImagePath => $state.composableBuilder(
      column: $state.table.backgroundImagePath,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<int> get primaryColorValue => $state.composableBuilder(
      column: $state.table.primaryColorValue,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<double> get backgroundImageOpacity => $state.composableBuilder(
      column: $state.table.backgroundImageOpacity,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<double> get backgroundImageBlur => $state.composableBuilder(
      column: $state.table.backgroundImageBlur,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<bool> get backgroundAffectsNavBar => $state.composableBuilder(
      column: $state.table.backgroundAffectsNavBar,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
}
...
class $$AppConfigsTableOrderingComposer
  ...
  ColumnOrderings<String> get configName => $state.composableBuilder(
      column: $state.table.configName,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<bool> get emailReminderEnabled => $state.composableBuilder(
      column: $state.table.emailReminderEnabled,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<bool> get isDebugMode => $state.composableBuilder(
      column: $state.table.isDebugMode,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<String> get backgroundImagePath => $state.composableBuilder(
      column: $state.table.backgroundImagePath,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<int> get primaryColorValue => $state.composableBuilder(
      column: $state.table.primaryColorValue,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<double> get backgroundImageOpacity =>
      $state.composableBuilder(
          column: $state.table.backgroundImageOpacity,
          builder: (column, joinBuilders) =>
              ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<double> get backgroundImageBlur => $state.composableBuilder(
      column: $state.table.backgroundImageBlur,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<bool> get backgroundAffectsNavBar => $state.composableBuilder(
      column: $state.table.backgroundAffectsNavBar,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
}

typedef $$LocalNoticesTableInsertCompanionBuilder = LocalNoticesCompanion
    Function({
  Value<int> id,
  required String noticeId,
  required String title,
...
typedef $$LocalNoticesTableUpdateCompanionBuilder = LocalNoticesCompanion
    Function({
  Value<int> id,
  Value<String> noticeId,
  Value<String> title,
...
class $$LocalNoticesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $LocalNoticesTable,
    LocalNotice,
    $$LocalNoticesTableFilterComposer,
    $$LocalNoticesTableOrderingComposer,
    $$LocalNoticesTableProcessedTableManager,
    $$LocalNoticesTableInsertCompanionBuilder,
  ...
  $$LocalNoticesTableTableManager(_$AppDatabase db, $LocalNoticesTable table)
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$LocalNoticesTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$LocalNoticesTableOrderingComposer(ComposerState(db, table)),
          getChildManagerBuilder: (p) =>
              $$LocalNoticesTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
            ...
            Value<String> description = const Value.absent(),
            Value<int> createdAt = const Value.absent(),
            Value<int> remindersAt = const Value.absent(),
...
class $$LocalNoticesTableProcessedTableManager extends ProcessedTableManager<
    _$AppDatabase,
    $LocalNoticesTable,
    LocalNotice,
    $$LocalNoticesTableFilterComposer,
    ...
    $$LocalNoticesTableInsertCompanionBuilder,
    $$LocalNoticesTableUpdateCompanionBuilder> {
  $$LocalNoticesTableProcessedTableManager(super.$state);
}

class $$LocalNoticesTableFilterComposer
    extends FilterComposer<_$AppDatabase, $LocalNoticesTable> {
  $$LocalNoticesTableFilterComposer(super.$state);
  ColumnFilters<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));

  ColumnFilters<String> get noticeId => $state.composableBuilder(
      column: $state.table.noticeId,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ColumnFilters<int> get remindersAt => $state.composableBuilder(
      column: $state.table.remindersAt,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$LocalNoticesTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $LocalNoticesTable> {
  $$LocalNoticesTableOrderingComposer(super.$state);
  ColumnOrderings<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));

  ColumnOrderings<String> get noticeId => $state.composableBuilder(
      column: $state.table.noticeId,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<int> get remindersAt => $state.composableBuilder(
      column: $state.table.remindersAt,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
typedef $$NotificationHistorysTableInsertCompanionBuilder
    = NotificationHistorysCompanion Function({
  Value<int> id,
  required String notificationId,
  required String title,
  required String message,
...
typedef $$NotificationHistorysTableUpdateCompanionBuilder
    = NotificationHistorysCompanion Function({
  Value<int> id,
  Value<String> notificationId,
  Value<String> title,
...
class $$NotificationHistorysTableTableManager extends RootTableManager<
    _$AppDatabase,
    $NotificationHistorysTable,
    NotificationHistory,
    $$NotificationHistorysTableFilterComposer,
    $$NotificationHistorysTableOrderingComposer,
    $$NotificationHistorysTableProcessedTableManager,
    $$NotificationHistorysTableInsertCompanionBuilder,
    $$NotificationHistorysTableUpdateCompanionBuilder> {
  $$NotificationHistorysTableTableManager(
      _$AppDatabase db, $NotificationHistorysTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer: $$NotificationHistorysTableFilterComposer(
              ComposerState(db, table)),
          orderingComposer: $$NotificationHistorysTableOrderingComposer(
              ComposerState(db, table)),
          getChildManagerBuilder: (p) =>
              $$NotificationHistorysTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
...
class $$NotificationHistorysTableProcessedTableManager
    extends ProcessedTableManager<
        ...
        $$NotificationHistorysTableInsertCompanionBuilder,
        $$NotificationHistorysTableUpdateCompanionBuilder> {
  $$NotificationHistorysTableProcessedTableManager(super.$state);
}

class $$NotificationHistorysTableFilterComposer
    extends FilterComposer<_$AppDatabase, $NotificationHistorysTable> {
  $$NotificationHistorysTableFilterComposer(super.$state);
  ColumnFilters<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$NotificationHistorysTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $NotificationHistorysTable> {
  $$NotificationHistorysTableOrderingComposer(super.$state);
  ColumnOrderings<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
typedef $$CustomTemplatesTableInsertCompanionBuilder = CustomTemplatesCompanion
    Function({
  Value<int> id,
  required String name,
  Value<String?> description,
...
class $$CustomTemplatesTableTableManager extends RootTableManager<
    ...
    $$CustomTemplatesTableProcessedTableManager,
    $$CustomTemplatesTableInsertCompanionBuilder,
  ...
  $$CustomTemplatesTableTableManager(
      ...
      : super(TableManagerState(
          ...
          table: table,
          filteringComposer:
              $$CustomTemplatesTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$CustomTemplatesTableOrderingComposer(ComposerState(db, table)),
          getChildManagerBuilder: (p) =>
              $$CustomTemplatesTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<String?> description = const Value.absent(),
...
class $$CustomTemplatesTableProcessedTableManager extends ProcessedTableManager<
    _$AppDatabase,
    $CustomTemplatesTable,
    CustomTemplate,
    $$CustomTemplatesTableFilterComposer,
    ...
    $$CustomTemplatesTableInsertCompanionBuilder,
    $$CustomTemplatesTableUpdateCompanionBuilder> {
  $$CustomTemplatesTableProcessedTableManager(super.$state);
}

class $$CustomTemplatesTableFilterComposer
    extends FilterComposer<_$AppDatabase, $CustomTemplatesTable> {
  $$CustomTemplatesTableFilterComposer(super.$state);
  ColumnFilters<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
  ...
  ColumnFilters<String> get tasksJson => $state.composableBuilder(
      column: $state.table.tasksJson,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$CustomTemplatesTableOrderingComposer
    extends OrderingComposer<_$AppDatabase, $CustomTemplatesTable> {
  $$CustomTemplatesTableOrderingComposer(super.$state);
  ColumnOrderings<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
  ...
  ColumnOrderings<String> get tasksJson => $state.composableBuilder(
      column: $state.table.tasksJson,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class _$AppDatabaseManager {
  ...
  $$NotificationHistorysTableTableManager get notificationHistorys =>
      $$NotificationHistorysTableTableManager(_db, _db.notificationHistorys);
